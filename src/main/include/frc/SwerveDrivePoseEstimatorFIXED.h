...
#include "frc/TimeInterpolatableBufferFIXED.h"
...
class SwerveDrivePoseEstimatorFIXED {
 public:
  /**
   * Constructs a SwerveDrivePoseEstimatorFIXED with default standard deviations
   ...
   */
  SwerveDrivePoseEstimatorFIXED(
      SwerveDriveKinematics<NumModules>& kinematics,
      const Rotation2d& gyroAngle,
      const wpi::array<SwerveModulePosition, NumModules>& modulePositions,
      const Pose2d& initialPose)
      : SwerveDrivePoseEstimatorFIXED{kinematics,      gyroAngle,
                                 modulePositions, initialPose,
                                 {0.1, 0.1, 0.1}, {0.9, 0.9, 0.9}} {}

  /**
   * Constructs a SwerveDrivePoseEstimatorFIXED.
   *
   * @param kinematics A correctly-configured kinematics object for your
   *     drivetrain.
   * @param gyroAngle The current gyro angle.
 ...
 private:
  ...
  TimeInterpolatableBufferFIXED<InterpolationRecord> m_poseBuffer{
...
extern template class EXPORT_TEMPLATE_DECLARE(WPILIB_DLLEXPORT)
    SwerveDrivePoseEstimatorFIXED<4>;
