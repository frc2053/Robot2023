...
public:
  ...
  frc2::CommandPtr BalanceFactory(std::function<bool()> fromBack, std::function<bool()> wantsToOverride, std::function<bool()> skipBalance, std::function<units::radian_t()> angleGoal);  frc2::CommandPtr CharacterizeDT(std::function<bool()> nextStepButton);
